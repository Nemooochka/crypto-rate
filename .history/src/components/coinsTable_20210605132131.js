...
export default function CoinsTable() {
  ...
  const renderCoinsTable = () => {
    ...
    actualData.map(elem => console.log(elem));
      ...
      <div class={styles.coins}>
        ...
        <div class={styles.coinsTable}>
          ...
          <div class={styles.tbody}>
            {actualData.map(coin => {
              console.log(actualData[coin], actualData[coin][activeFiat])
              return (
                <div class={styles.tr} id={actualData[coin][activeFiat]['coinName']}>
                  <GenerateCoinsTable coinData={actualData[coin]} />
                </div>
              );
            })}
          </div>
