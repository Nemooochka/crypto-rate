...
export default function CoinsTable({ activeFiat, availableFiats }) {
  ...
  const renderCoinsTable = () => {
    ...
    const { coinsDataUpd, availableFiats, filteredArr, activeFiat } = window.dataStorage;
  ...
  return <SelectFiat activeFiat={activeFiat} />;
}
