...
export default function CoinsTable({ availableFiats, coinsDataUpd }) {
  const [activeFiat, setActiveFiat] = useState('USD');
  const [filteredArr, setfilteredArr] = useState('USD');
          ...
          {headers.map(elem => {
            return (
              <div
                ...
                onclick={e => Filters(e.currentTarget, coinsDataUpd, activeFiat, setActiveFilter)}
