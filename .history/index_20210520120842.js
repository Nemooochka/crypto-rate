...
window.filter = event => {
  ...
  for (let data in coinsDataUpd) {
    ...
    filteredArr = coinsDataUpd.sort(function(a,b) {
      console.log(a, b, a[activeFiat][activeFilterName], b[activeFiat][activeFilterName]);
      return a[activeFiat][activeFilterName] - formatNumberValue(b[activeFiat][activeFilterName]);
    });
