...
window.rearengeData = coinsDataDisplay => {
  ...
  for (let coin in coinsDataDisplay) {
    for (let fiat in coinsDataDisplay[coin]) {
      coinsDataDisplay[coin][fiat]['coinName'] = window.dataStorage.coinsDataFull[coin][fiat]['FROMSYMBOL'];
      coinsDataDisplay[coin][fiat]['coinPrice'] = window.dataStorage.coinsDataFull[coin][fiat]['PRICE'];
      coinsDataDisplay[coin][fiat]['coinChange'] = window.dataStorage.coinsDataFull[coin][fiat]['CHANGEPCTDAY'];
      coinsDataDisplay[coin][fiat]['coinCap'] = window.dataStorage.coinsDataFull[coin][fiat]['MKTCAP'];
      coinsDataDisplay[coin][fiat]['coinVolume'] = window.dataStorage.coinsDataFull[coin][fiat]['VOLUMEDAYTO'];
    }
    coinsDataUpd.push(coinsDataDisplay[coin]);
  }

  console.log(coinsDataDisplay);
